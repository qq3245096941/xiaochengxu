<template>
	<view style="margin-bottom: 30rpx;">
		...
		<view style="padding: 50rpx;font-size: 30rpx;">{{commdity.commdityName}} <text style="color:#ed4014;float: right;">￥{{commdity.commdityPrice}}</text></view>
		<view class="quality">
			<van-icon name="gem-o" /><text style="margin-right: 30rpx;">30天质保</text>
			<van-icon name="gem-o" /><text style="margin-right: 30rpx;">正品保证</text>
			<van-icon name="gem-o" /><text style="margin-right: 30rpx;">7天退货</text>
			<van-icon name="gem-o" /><text style="margin-right: 50rpx;">全国联保</text>
		</view>
		<van-tabs active="0">
