<template>
	<view>
			...
			<view class="header-position-grid" style="margin-top: 40rpx;">
				<navigator url="../order/order?index=0">
					<view class="header-position-grid-box">
						<image class="header-position-grid-image" src="https://xcx.zhongshengzb.com:8089/shoppingImg/images/my-icon/mine01.png"
						 mode=""></image>
				...
				<navigator url="../Invitation/Invitation">
					<view class="header-position-grid-box">
						<image class="header-position-grid-image" src="https://xcx.zhongshengzb.com:8089/shoppingImg/images/my-icon/mine02.png"
						 mode=""></image>
				...
				<view class="header-position-grid-box" @click="discountCoupon">
					<image style="margin-left: 30rpx;" class="header-position-grid-image" src="https://xcx.zhongshengzb.com:8089/shoppingImg/images/my-icon/mine03.png"
					 mode=""></image>
		...
		<view class="serviceSettings">
			...
			<view class="serviceSettings-box" @click="goToFeedback">
				<image class="serviceSettings-image" src="../../static/mine/feedback.png" mode=""></image>
