<template>
<uni-shadow-root class="vant-dist-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = 'vant/dist/index-bar/index'
...
export default global['__wxComponents']['vant/dist/index-bar/index']
</script>
