<template>
<uni-shadow-root class="vant-dist-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="'z-index: '+(zIndex)+';'" @click.native="onTap">
...
global['__wxRoute'] = 'vant/dist/notify/index'
...
export default global['__wxComponents']['vant/dist/notify/index']
</script>
